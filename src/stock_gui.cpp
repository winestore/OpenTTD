...
static constexpr std::initializer_list<NWidgetPart> _nested_stock_market_widgets = {
	NWidget(NWID_HORIZONTAL),
		...
		NWidget(WWT_CAPTION, COLOUR_BROWN, WID_STM_CAPTION), SetStringTip(STR_JUST_STRING1, STR_TOOLTIP_WINDOW_TITLE_DRAG_THIS), SetTextStyle(TC_WHITE),
	...
	EndContainer(),
	NWidget(NWID_HORIZONTAL),
		NWidget(WWT_PUSHTXTBTN, COLOUR_BROWN, WID_STM_BUY_BUTTON), SetMinimalSize(80, 12), SetStringTip(STR_JUST_STRING1, STR_NULL), SetTextStyle(TC_WHITE),
		NWidget(WWT_PUSHTXTBTN, COLOUR_BROWN, WID_STM_SELL_BUTTON), SetMinimalSize(80, 12), SetStringTip(STR_JUST_STRING1, STR_NULL), SetTextStyle(TC_WHITE),
		NWidget(WWT_PUSHTXTBTN, COLOUR_BROWN, WID_STM_COMPANY_INFO), SetMinimalSize(80, 12), SetStringTip(STR_JUST_STRING1, STR_NULL), SetTextStyle(TC_WHITE),
...
static constexpr std::initializer_list<NWidgetPart> _nested_stock_trade_widgets = {
	NWidget(NWID_HORIZONTAL),
		...
		NWidget(WWT_CAPTION, COLOUR_GREY, WID_ST_CAPTION), SetStringTip(STR_JUST_STRING1, STR_TOOLTIP_WINDOW_TITLE_DRAG_THIS),
	EndContainer(),
	NWidget(WWT_PANEL, COLOUR_GREY),
		NWidget(NWID_VERTICAL), SetPadding(10),
			...
			NWidget(NWID_HORIZONTAL),
				NWidget(WWT_TEXT, INVALID_COLOUR, WID_ST_QUANTITY_LABEL), SetStringTip(STR_JUST_STRING1, STR_NULL), SetMinimalSize(60, 12),
				NWidget(WWT_PUSHARROWBTN, COLOUR_GREY, WID_ST_QUANTITY_DOWN), SetArrowWidgetTypeTip(AWV_DECREASE, STR_NULL),
				NWidget(WWT_TEXT, INVALID_COLOUR, WID_ST_QUANTITY_TEXT), SetMinimalSize(50, 12),
				NWidget(WWT_PUSHARROWBTN, COLOUR_GREY, WID_ST_QUANTITY_UP), SetArrowWidgetTypeTip(AWV_INCREASE, STR_NULL),
			EndContainer(),
			NWidget(NWID_SPACER), SetMinimalSize(0, 5),
			NWidget(WWT_TEXT, INVALID_COLOUR, WID_ST_TOTAL_COST), SetMinimalSize(200, 12), SetFill(1, 0),
			NWidget(NWID_SPACER), SetMinimalSize(0, 10),
			NWidget(NWID_HORIZONTAL),
				NWidget(WWT_PUSHTXTBTN, COLOUR_GREY, WID_ST_EXECUTE), SetMinimalSize(80, 12), SetStringTip(STR_JUST_STRING1, STR_NULL), SetFill(1, 0),
				NWidget(NWID_SPACER), SetMinimalSize(10, 0),
				NWidget(WWT_PUSHTXTBTN, COLOUR_GREY, WID_ST_CANCEL), SetMinimalSize(80, 12), SetStringTip(STR_JUST_STRING1, STR_NULL), SetFill(1, 0),
			EndContainer(),
		EndContainer(),
	EndContainer(),
};
